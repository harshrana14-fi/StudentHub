...
export default function ToolsPage() {
  const tools = [
    ...
    },
    {
      ...
      description: 'Generate complete research papers with human-like tone and structure. Avoid AI detection with natural phrasing.',
      icon: Sparkles,
      status: 'active',
    ...
    },
    {
      ...
      description: 'Check your content against millions of academic papers and web sources. Get detailed reports.',
      icon: Zap,
      status: 'active',
