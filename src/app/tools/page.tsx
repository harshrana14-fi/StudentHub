    ...
    <div className="min-h-screen bg-[#f0f0f0]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          ...
          <div className="text-left">
            <div className="inline-block bg-black text-white px-8 py-5 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,0.3)] mb-6">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-none flex items-center gap-4">
                <Wrench className="w-16 h-16" /> All Tools
              </h1>
            </div>
            
            <p className="text-2xl md:text-3xl text-black font-black leading-tight max-w-3xl">
              Explore our <span className="text-amber-600">AI-powered tools</span> designed for students
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-black text-black mb-6 flex items-center justify-center gap-3">
            Powerful Tools for Students <Sparkles className="w-12 h-12" />
          </h2>
      ...
      <div className="border-t-4 border-black bg-gradient-to-r from-amber-200 via-slate-200 to-stone-200 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-5xl font-black text-black mb-6 flex items-center justify-center gap-3">
            Can't Find What You Need? <Zap className="w-12 h-12" />
          </h2>
          <div className="bg-white border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] mb-8">
            <p className="text-xl font-bold text-black">
              We're constantly adding new tools based on student feedback. Stay tuned for more!
            </p>
          </div>
          <Link
            href="/"
